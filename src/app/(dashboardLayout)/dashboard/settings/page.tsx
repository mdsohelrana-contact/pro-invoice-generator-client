...
const SettingsPage = () => {
  // const { updateUser, company, updateCompany, setLanguage,  updateNotificationSettings, currency, setCurrency } = useStore()
  ...
  const handleProfileSave = (e: React.FormEvent) => {
    ...
    toast.success(
      language === "en"
        ...
        : "প্রোফাইল সেটিংস আপডেট করা হয়েছে!"
    );
  };
  ...
  const handleCompanySave = (e: React.FormEvent) => {
    ...
    toast.success(
      language === "en"
        ...
        : "কম্পানি সেটিংস আপডেট করা হয়েছে!"
    );
  };
  ...
  const handleNotificationSave = () => {
    ...
    toast.success(
      language === "en"
        ...
        : "নোটিফিকেশন সেটিংস আপডেট করা হয়েছে!"
    );
  };
        ...
        <TabsContent value="billing">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-2">
                <Label>
                  {language === "en" ? "Billing History" : "বিলিং ইতিহাস"}
                </Label>
            ...
            <CardHeader>
              ...
              <CardDescription>
                {language === "en"
                  ...
                  : "আপনার অ্যাপ্লিকেশন অভিজ্ঞতা কাস্টমাইজ করুন।"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <LanguageButton />
              <div className="grid gap-2">
                <Label>
                  {language === "en" ? "Default Currency" : "ডিফল্ট মুদ্রা"}
                </Label>
                <p className="font-medium">BDT - Bangladeshi Taka</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
